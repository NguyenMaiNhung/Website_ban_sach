					...
					<div class="mb-4">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label>Customer's Name</label> <input class="form-control"
									type="text" placeholder="Your name" name="name"
									value="${account.name_real }" readonly="readonly">
							</div>
							<div class="col-md-6 form-group">
								<label>E-mail</label> <input class="form-control" type="text"
									placeholder="Your email" name="email" value="${account.email }"
									readonly="readonly">
							</div>
							<div class="col-md-6 form-group">
								<label>Mobile No</label> <input class="form-control"
									type="number" placeholder="Your phone number" name="phone"
									value="${account.phone_number }">
							</div>
							<div class="col-md-6 form-group">
								<label>Ship to Address</label> <input class="form-control"
									type="text" placeholder="Your address" name="address"
							...
							<div class="col-md-6 form-group">
								...
								<textarea class="form-control" type="text"
									placeholder="Do you have any requests?" cols="30" rows="5"
									name="note"></textarea>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4">
					<div class="card border-secondary mb-5">
						...
						<div class="card-body">
							...
							<c:forEach items="${list_items_in_cart }" var="item">
							...
							<div class="d-flex justify-content-between mb-3 pt-1">
								...
								<h6 class="font-weight-medium">${total_all_items }đ</h6>
							</div>
							<div class="d-flex justify-content-between">
								<h6 class="font-weight-medium">Shipping</h6>
								<h6 class="font-weight-medium">10000đ</h6>
							</div>
						</div>
						<div class="card-footer border-secondary bg-transparent">
							<div class="d-flex justify-content-between mt-2">
								<h5 class="font-weight-bold">Total</h5>
								<h5 class="font-weight-bold">${(total_all_items + 10000) }đ</h5>
							</div>
						</div>
					</div>
					<div class="card border-secondary mb-5">
					...
					<pclass "text-success">${checkoutComplete }</p> 
				</div>
			</div>
		</form>
	</div>
