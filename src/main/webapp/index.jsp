...
<body>
						...
						<div class="carousel-item active" style="height: 410px;">
							...
							<div
								...
								<div class="p-3" style="max-width: 700px;">
									...
									<h3 class="display-4 text-white font-weight-semi-bold mb-4">Detective
										Novels</h3>
									<a href="shop?num=${0 }" class="btn btn-light py-2 px-3">Shop
										Now</a>
								</div>
							</div>
						</div>
						<div class="carousel-item" style="height: 410px;">
							<img class="img-fluid" src="img/banner.jpg" alt="Image">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
									<h4 class="text-light text-uppercase font-weight-medium mb-3">10%
										Off Your First Order</h4>
									<h3 class="display-4 text-white font-weight-semi-bold mb-4">Romance
										Novels</h3>
									<a href="shop?num=${0 }" class="btn btn-light py-2 px-3">Shop
										Now</a>
								</div>
						...
						<div class="carousel-item" style="height: 410px;">
							...
							<div
								...
								<div class="p-3" style="max-width: 700px;">
									<h4 class="text-light text-uppercase font-weight-medium mb-3">10%
										Off Your First Order</h4>
									<h3 class="display-4 text-white font-weight-semi-bold mb-4">Classic
										Literature</h3>
									<a href="shop?num=${0 }" class="btn btn-light py-2 px-3">Shop
										Now</a>
								</div>
	...
	<div class="container-fluid pt-5">
		<div class="text-center mb-4">
			<h2 class="section-title px-5">
				<span class="px-2">Bestselling Books</span>
			</h2>
		</div>
		<div class="row px-xl-5 pb-3">
			<c:forEach items="${sortBooks }" var="book">
				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
					<div class="card product-item border-0 mb-4">
						...
						<div
							...
							<div class="d-flex justify-content-center">
								<h6>${book.gia_ban }đ</h6>
								<h6 class="text-muted ml-2">
									<del>${book.gia_goc }đ</del>
								</h6>
							</div>
						</div>
						<div
							class="card-footer d-flex justify-content-between bg-light border">
							<a href="detail?id=${book.id }" class="btn btn-sm text-dark p-0"><i
								class="fas fa-eye text-primary mr-1"></i>View Detail</a> <a
								href="check?action=cart&&id=${book.id }&&page=${1}"
		...
		<div class="row px-xl-5">
			<div class="col-md-6 pb-4">
				<div
					...
					<img src="img/sher.png" alt="">
					<div class="position-relative" style="z-index: 1;">
						<h5 class="text-uppercase text-primary mb-3">20% off the all
							order</h5>
						<h1 class="mb-4 font-weight-semi-bold">Detective Novels</h1>
						<a href="shop?num=${0 }"
			...
			<div class="col-md-6 pb-4">
				<div
					...
					<img src="img/love3.png" alt="">
					<div class="position-relative" style="z-index: 1;">
						<h5 class="text-uppercase text-primary mb-3">20% off the all
							order</h5>
						<h1 class="mb-4 font-weight-semi-bold">Romance Novels</h1>
						<a href="shop?num=${0 }"
							class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
					</div>
				</div>
	...
	<div class="container-fluid pt-5">
		...
		<div class="row px-xl-5 pb-3">
			<c:forEach items="${arrivedBooks }" var="book">
				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
					<div class="card product-item border-0 mb-4">
						<div
							class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
