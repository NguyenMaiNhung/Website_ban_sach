				...
				<nav
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="home" class="nav-item nav-link">Home</a> <a href="shop?num=${0 }"
						...
						<div
							...
							<div class="dropdown ml-4">
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item" href="shop?num=${-1}">Latest</a>
									<a class="dropdown-item" href="shop?num=${-2}">Popularity</a>
								</div>
							</div>
						</div>
					</div>
					<c:forEach items="${list_book_by_key }" var="book">
