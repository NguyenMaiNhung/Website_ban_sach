...
<script type="text/javascript">
	function deleteItem(id_bill) {
		if (confirm("do you want to delete this bill?")) {
			window.location = "deletebill?id_bill=" + id_bill;
		}
	}
</script>
</head>
...
<body>
	...
	<div class="container-fluid bg-secondary mb-5">
		<div
			...
			<h1 class="font-weight-semi-bold text-uppercase mb-3">Checkout
				Ordered</h1>
			<div class="d-inline-flex">
				...
				<p class="m-0 px-2">-</p>
				<p class="m-0">${account.username }Odered</p>
			</div>
		</div>
	</div>
	<!-- Page Header End -->
	...
	<div class="container-fluid pt-5">
		<div class="row px-xl-5">
			<div class="table-responsive mb-5">
				<p class="text-success">* ${mess_succ }</p>
				<table class="table table-bordered text-center mb-0">
					...
					<tbody class="align-middle">
						<c:forEach items="${list_bill }" var="bill">
							<tr>
								<td class="align-middle"><img src="${bill.book.image }"
									alt="" style="width: 50px;"></td>
								<td class="align-middle">${bill.book.title }</td>
								<td class="align-middle">${bill.book.gia_goc }đ</td>
								<td class="align-middle">${bill.amount }</td>
								<td class="align-middle">${bill.total }đ</td>
								<td class="align-middle">${bill.ngay_dat }</td>
								<td class="align-middle">Đang giao</td>
								...
								<td class="align-middle"><a class="btn btn-sm btn-primary"
									href="detail?id=${bill.book.id }"> View</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
