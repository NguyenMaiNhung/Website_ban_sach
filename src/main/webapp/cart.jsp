...
<script type="text/javascript">
	function deleteItem(id_book, id_kh) {
		window.location = "delete?id_book=" + id_book + "&&id_kh=" + id_kh;
	}
</script>
</head>
				...
				<table class="table table-bordered text-center mb-0">
					...
					<tbody class="align-middle">
						<c:forEach items="${list_items_in_cart }" var="item">
							<tr>
								<td class="align-middle"><img src="${item.book.image }"
									alt="" style="width: 50px;"></td>
								<td class="align-middle">${item.book.title }</td>
								<td class="align-middle">${item.book.gia_ban }đ</td>
								<td class="align-middle">${item.amount }</td>
								<td class="align-middle">${item.total }đ</td>
								<td class="align-middle"><button
										onclick="deleteItem('${item.book.id}', '${item.id_kh }')"
										class="btn btn-sm btn-primary">
										<i class="fa fa-times"></i>
									</button></td>
								<td class="align-middle"><a class="btn btn-sm btn-primary" href="detail?id=${item.book.id }"> Add Amount</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			<div class="col-lg-4">
				...
				<div class="card border-secondary mb-5">
					...
					<div class="card-footer border-secondary bg-transparent">
						...
						<a class="btn btn-block btn-primary my-3 py-3" href="checkout">Proceed
							To Checkout</a>
					</div>
				</div>
			</div>
