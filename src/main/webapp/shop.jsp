...
<body>
	...
	<div class="container-fluid bg-secondary mb-5">
		<div
			...
			<h1 class="font-weight-semi-bold text-uppercase mb-3">${cate.name }</h1>
						...
						<div
							...
							<div class="dropdown ml-4">
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item" href="cate?id=${id }&&num=${-1}">Latest</a>
									<a class="dropdown-item" href="cate?id=${id }&&num=${-2}">Popularity</a>
								</div>
							</div>
						</div>
					</div>
					<c:forEach items="${list_book_cate }" var="book">
