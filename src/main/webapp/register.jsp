				...
				<div class="register">
					<form action="register" method="post">
						<div class="register-top-grid">
							...
							<div class="mation">
								<span>Your Name<label>*</label></span> <input type="text"
									name="name" required="required"> <span>Phone
									Number<label>*</label>
								</span> <input type="number" name="phone" required="required">

								<span>Email Address<label>*</label></span> <input type="email"
									name="email" required="required"> <span>Your
									Address<label>*</label>
								</span> <input type="text" name="address" required="required">
							</div>
						...
						<div class="register-bottom-grid">
							...
							<div class="mation">
								<span>User Name<label>*</label></span> <input type="text"
									name="username" required="required"> <span>Password<label>*</label></span>
